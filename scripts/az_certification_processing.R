...
# Change the full_name to upper case
az_history$full_name <- str_to_upper(az_history$full_name)
...
az_history$start_date <- ymd(az_history$start_date)
# Ensure end_date is yyyymmdd format using ymd
az_history$end_date <- ymd(az_history$end_date)
